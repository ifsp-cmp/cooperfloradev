            ...
            <div className="Cartoes">
                <div className="Cartao">
                    ...
                    <div className="TextoCartao">
                        <p>Produzir alimentos de alto valor nutritivo senguindo os preceitos da Agroecologia e a preço justo, promovendo o desenvolvimento social e econômico para nosso cooperados proporcionando uma melhor qualidade de vida para nossos consumidores e produtores.</p>
                    </div>
                </div>
                <div className="Cartao">
                    <div className="BordaCartao">
                    ...
                    <div className="TextoCartao">
                        <p>Ser referencia na produção de alimentos agroecológicos .</p>
                    </div>
                </div>
                <div className="Cartao">
                    <div className="BordaCartao">
